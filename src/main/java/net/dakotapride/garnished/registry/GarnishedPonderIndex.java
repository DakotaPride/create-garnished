...
public class GarnishedPonderIndex {
    ...
    public static void index() {
        ...
        HELPER.forComponents(GarnishedItems.WOODEN_HATCHET, GarnishedItems.STONE_HATCHET, GarnishedItems.IRON_HATCHET, GarnishedItems.GOLDEN_HATCHET,
                GarnishedItems.DIAMOND_HATCHET, GarnishedItems.NETHERITE_HATCHET, GarnishedItems.AMETRINE_HATCHET, GarnishedItems.AQUAMARINE_HATCHET,
                GarnishedItems.JADE_HATCHET, GarnishedItems.RUBY_HATCHET, GarnishedItems.GILDED_NETHERITE_HATCHET, GarnishedItems.ROSE_GOLD_HATCHET,
                GarnishedItems.SAPPHIRE_HATCHET, GarnishedItems.TOPAZ_HATCHET, GarnishedItems.WARDEN_HATCHET)
    ...
    public static class Tags {
        public static PonderTag
                RECENT_CHANGES = create("recent_changes").item(GarnishedItems.BUHG, true, false)
                        .defaultLang("recent_changes", "recent_changes_description")
                        .addToIndex(),
                KELP_RELATED = create("kelp_related").item(GarnishedItems.DRIED_VERMILION_KELP, true, false)
                        .defaultLang("kelp_entries", "kelp_entries_description")
                        .addToIndex(),
                MASTIC_RESIN = create("mastic_resin").item(GarnishedItems.MASTIC_RESIN, true, true)
                        .defaultLang("mastic_resin", "mastic_resin_description")
                        .addToIndex(),
                CRACKED_NUTS = create("cracked_nuts").item(GarnishedItems.CRACKED_WALNUT, true, false)
                        .defaultLang("cracked_nuts", "cracked_nuts_description")
                        .addToIndex(),
                HATCHETS = create("hatchets").item(GarnishedItems.IRON_HATCHET, true, true)
                        .defaultLang("hatchets", "hatchets_description")
                        .addToIndex(),
                CRUSHED_NETHER_INGREDIENTS = create("crushed_nether_ingredients").item(GarnishedItems.BRITTLE_DUST, true, true)
        ...
        public static void fillPonderTags() {
            ...
            PonderRegistry.TAGS.forTag(HATCHETS)
                    ...
                    .add(GarnishedItems.AMETRINE_HATCHET)
                    .add(GarnishedItems.AQUAMARINE_HATCHET)
                    .add(GarnishedItems.JADE_HATCHET)
                    .add(GarnishedItems.TOPAZ_HATCHET)
                    .add(GarnishedItems.GILDED_NETHERITE_HATCHET)
                    .add(GarnishedItems.ROSE_GOLD_HATCHET)
                    .add(GarnishedItems.RUBY_HATCHET)
                    .add(GarnishedItems.SAPPHIRE_HATCHET)
