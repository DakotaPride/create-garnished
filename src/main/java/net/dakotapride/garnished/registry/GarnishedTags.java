...
public class GarnishedTags {
	...
	public static TagKey<Item> AVERSION_FOODS_TAG = garnishedTag("aversion_foods", BuiltInRegistries.ITEM);
	public static TagKey<Item> HATCHETS_TAG = commonTag("tools/hatchets", BuiltInRegistries.ITEM);
	public static TagKey<Fluid> GARNISHED_FLUIDS_TAG = garnishedTag("fluids", BuiltInRegistries.FLUID);
	...
	public static TagKey<Item> COPPER_INGOTS = commonTag("ingots/copper", BuiltInRegistries.ITEM);
	...
	public static TagKey<Item> WARDEN_REPAIRABLE_ITEMS = commonTag("shards/warden", BuiltInRegistries.ITEM);

	 public static TagKey<Item> JADE_GEMS = commonTag("ingots/jade", BuiltInRegistries.ITEM);
	 public static TagKey<Item> TOPAZ_GEMS = commonTag("ingots/topaz", BuiltInRegistries.ITEM);
	 public static TagKey<Item> AQUAMARINE_GEMS = commonTag("ingots/aquamarine", BuiltInRegistries.ITEM);
	 public static TagKey<Item> SAPPHIRE_GEMS = commonTag("ingots/sapphire", BuiltInRegistries.ITEM);
	 public static TagKey<Item> RUBY_GEMS = commonTag("ingots/ruby", BuiltInRegistries.ITEM);
	 public static TagKey<Item> AMETRINE_GEMS = commonTag("ingots/ametrine", BuiltInRegistries.ITEM);
